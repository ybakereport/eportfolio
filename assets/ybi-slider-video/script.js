    ...
    if (!$('html').hasClass('is-builder')) {
        $(document).on('add.cards', function(event) {
            ...
            $(event.target).outerFind('[data-bg-video-slide]').each(function() {
                ...
                var $preview = $('<div class="ybi-background-video-preview"></div>').css({
                    display: 'none',
                ...
                var $overlay = $(this).find('.ybi-overlay');
                ...
                if (playerName === 'youtube') {
                    ...
                    if (isDesktop && $.fn.YTPlayer && !$(this).find('.playerBox').length) {
                        $('.container-slide', this)
                            .before('<div class="ybi-background-video"></div>').prev()
                            .YTPlayer({
                                videoURL: videoId,
                                containment: 'self',
                                showControls: false,
                        ...
                        $(this).find('.image_wrapper .ybi-overlay').css('opacity', '0');
                    }
                } else {
